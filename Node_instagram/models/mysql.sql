...
CONSTRAINT domainUserNick FOREIGN KEY (userNick) REFERENCES nodeInstagram.User (nick) ON DELETE CASCADE ON UPDATE CASCADE)
DEFAULT CHARACTER SET = utf8
ENGINE = InnoDB;
...
CONSTRAINT followingNick FOREIGN KEY (followingNick) REFERENCES nodeInstagram.User (nick) ON DELETE CASCADE ON UPDATE CASCADE,
CONSTRAINT followingimg FOREIGN KEY (followingimg) REFERENCES nodeInstagram.User (img) ON DELETE CASCADE ON UPDATE CASCADE,
CONSTRAINT followerNick FOREIGN KEY (followerNick) REFERENCES nodeInstagram.User (nick) ON DELETE CASCADE ON UPDATE CASCADE,
CONSTRAINT followerimg FOREIGN KEY (followerimg) REFERENCES nodeInstagram.User (img) ON DELETE CASCADE ON UPDATE CASCADE)
DEFAULT CHARACTER SET = utf8
ENGINE = InnoDB;
